...
const TOPICS = [
  ...
  // Batch 3 — Nouveaux sujets (août 2026+)
  "Agent IA pour les cabinets d'orthodontie : rappels de rendez-vous, suivi des traitements et relances patients",
  "Comment un agent IA peut remplacer un assistant de direction sans perte de qualité : retour d'expérience",
  "Agent IA pour les syndics de copropriété : gestion des assemblées, convocations et suivi des travaux",
  "Agent IA multilingue pour les entreprises exportatrices : support client en 5 langues avec un seul workflow",
  "Agent IA pour les clubs sportifs professionnels : billetterie, relation fans et gestion des licences",
  "OpenClaw et Notion : construire un système de gestion de connaissances d'entreprise avec des agents IA",
  "Agent IA pour les hôtels indépendants : concierge digital, gestion des plaintes et upsell automatique",
  "Agent IA pour les laboratoires d'analyses médicales : gestion des prélèvements, résultats et rappels patients",
  "Agent IA pour les cabinets de radiologie : planification, comptes rendus et coordination avec les prescripteurs",
  "Comment auditer la sécurité d'un agent IA déployé en entreprise : checklist et méthodologie OpenClaw",
  "Agent IA pour les plateformes de e-learning : parcours adaptatifs, relances apprenants et reporting formateur",
  "Agent IA pour les associations sportives : gestion des adhésions, inscriptions aux compétitions et communication",
  "OpenClaw et Airtable : synchroniser données et agents IA pour des workflows hybrides sans code",
  "Agent IA pour les cabinets de sophrologie et hypnothérapie : agenda, rappels et suivi de séances",
  "Agent IA pour les agences de traduction : gestion des projets, relances clients et contrôle qualité",
  "Comment mesurer la maturité IA d'une PME avant de déployer un agent OpenClaw : grille d'évaluation",
  "Agent IA pour les régies de logements sociaux : traitement des demandes, suivi des interventions et alertes",
  "Agent IA pour les opérateurs de téléphonie : portabilité, réclamations et fidélisation automatisées",
  "Agent IA pour les studios de musique et labels : gestion des artistes, droits voisins et sorties de singles",
  "OpenClaw et Google Workspace : intégrer des agents IA dans Gmail, Drive et Calendar pour les PME françaises",
  "Agent IA pour les cliniques dentaires : rappels, devis automatisés et gestion des créneaux d'urgence",
  "Agent IA pour les courtiers en assurance : comparaison d'offres, relances clients et gestion des renouvellements",
  "Comment créer un agent IA de veille réglementaire sectorielle avec OpenClaw : guide méthodologique",
  "Agent IA pour les pépinières d'entreprises et incubateurs : suivi des startups, alertes de jalons et rapports",
  "Agent IA pour les cabinets de gestion de fortune : reporting patrimonial, veille fiscale et alertes marché",
  "OpenClaw et Slack : construire des agents IA intégrés à votre espace de travail collaboratif",
  "Agent IA pour les imprimeries et ateliers de reprographie : devis automatisés, suivi de production et livraison",
  "Comment éviter les hallucinations d'un agent IA en production : stratégies de validation avec OpenClaw",
  "Agent IA pour les cabinets de médecine du travail : visites médicales, alertes réglementaires et reporting RH",
  "Agent IA pour les plateformes de mise en relation B2B : qualification des leads et matching automatisé",
];
