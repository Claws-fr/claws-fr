  ...
  const jsonLd = [
    {
      ...
      author: { "@id": "https://claws.fr/#julie-decroix" },
      publisher: { "@id": "https://claws.fr/#organization" },
      wordCount: Math.round(post.content.split(/\s+/).length),
      speakable: {
        "@type": "SpeakableSpecification",
        cssSelector: ["h1", ".post-description", "h2", ".post-intro", "blockquote", ".key-stat"],
      },
      mainEntityOfPage: { "@type": "WebPage", "@id": `https://claws.fr/blog/${post.slug}` },
      keywords: post.keywords.join(", "),
      inLanguage: "fr-FR",
      image: { "@type": "ImageObject", url: "https://claws.fr/og-image.png", width: 1200, height: 630 },
      isPartOf: { "@type": "Blog", "@id": "https://claws.fr/blog", name: "Blog Claws", url: "https://claws.fr/blog" },
