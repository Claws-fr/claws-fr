...
export const sectors: Record<string, Sector> = {
  ...
  "infirmiers-liberaux": {
    ...
    faq: [
      ...
      { q: "L'agent peut-il se connecter à mon logiciel infirmier (Agathe YOU, Albus, Desmos, VEGA, Simply Vitale…) ?", a: "Non. Ces logiciels SESAM-Vitale sont des applications fermées sans API publique. L'agent ne les remplace pas et ne s'y connecte pas directement. Il travaille en parallèle sur tout ce qu'ils ne couvrent pas : coordination avec les médecins et aidants, suivi des ordonnances, relances patients, gestion des remplacements." },
