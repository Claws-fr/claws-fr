...
export const sectors: Record<string, Sector> = {
  ...
  entrepreneurs: {
    ...
    subheadline: "Gestion des emails, suivi des partenaires, relances commerciales, veille marché. Concentrez-vous sur ce que vous seul pouvez faire. L'agent gère le reste.",
    metaTitle: "Agent IA pour entrepreneurs et startups | Claws",
    metaDesc: "Automatisez l'opérationnel de votre startup avec un agent IA OpenClaw en local. Emails, relances, veille, reporting. Installation à partir de 189€. Claws, Paris.",
  ...
  freelances: {
    ...
    subheadline: "Relances devis, facturation, prospection en continu, onboarding clients. Quand vous travaillez pour vos clients, l'agent travaille pour vous.",
    metaTitle: "Agent IA pour freelances et indépendants | Claws",
    metaDesc: "Automatisez votre activité freelance avec un agent IA OpenClaw. Relances devis, facturation, prospection, onboarding clients. Installation à partir de 189€. Claws, Paris.",
  ...
  createurs: {
    ...
    subheadline: "Veille tendances, repurposing de contenu, réponses communauté, planning éditorial. Moins de logistique. Plus de création.",
    metaTitle: "Agent IA pour créateurs de contenu | YouTube, LinkedIn, Podcast | Claws",
    metaDesc: "Automatisez la logistique créative avec un agent IA OpenClaw. Veille, repurposing, planning, réponses communauté. Installation à partir de 189€. Claws, Paris.",
  ...
  cfo: {
    ...
    subheadline: "Reporting financier automatisé, alertes trésorerie, suivi des indicateurs clés, préparation des clôtures. L'agent gère la consolidation. Vous gérez la stratégie.",
    metaTitle: "Agent IA pour DAF et directeurs financiers | Claws",
    metaDesc: "Automatisez le reporting financier avec un agent IA OpenClaw en local. Tableaux de bord, alertes trésorerie, clôtures, analyse des écarts. Claws, Paris.",
