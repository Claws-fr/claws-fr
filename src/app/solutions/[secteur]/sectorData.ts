...
export const sectors: Record<string, Sector> = {
  ...
  "infirmiers-liberaux": {
    ...
    faq: [
      ...
      { q: "L'agent peut-il se connecter à mon logiciel de facturation et télétransmission ?", a: "Non. Les logiciels de facturation infirmière sont des applications locales fermées sans API. L'agent ne les remplace pas et ne s'y connecte pas. Il travaille en parallèle sur tout ce qu'ils ne couvrent pas : gestion des communications, relances patients, coordination soignants, suivi des ordonnances." },
